...
from smateway.hexcal_gain import STIMULUS_PROTOCOLS, stimulus_protocol
...
def main() -> int:
    ...
    expected_experiment_kind = (
        stimulus_protocol(str(protocol_id)).experiment_kind
        if protocol_id != "hexcal-v1"
    ...
    output = {
        "schema": 1,
        "calibration_kind": (
            stimulus_protocol(str(protocol_id)).calibration_kind
            if protocol_id != "hexcal-v1"
